...
public class Type2PetFragment extends Fragment {
    RecyclerView recyclerView_Product;
    ArrayList<DataProduct> arrayList;
    private Context context;
    public Type2PetFragment() {
        // Required empty public constructor
    }


    public static Type2PetFragment newInstance(String param1, String param2) {
        Type2PetFragment fragment = new Type2PetFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_type2_pet, container, false);
        mapView(view);
        extractProduct();
        initSearchView(view);
        return view;
